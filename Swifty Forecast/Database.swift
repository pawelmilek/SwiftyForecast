...
final class Database {
    ...
    var cities = [ City(name: "Dublin", country: "Ireland", latitude: 53.349805, longitude: -6.260310),
                   City(name: "London", country: "England", latitude: 51.507351, longitude: -0.127758),
                   City(name: "New York", country: "US", latitude: 40.712784, longitude: -74.005941),
                   City(name: "Barcelona", country: "Spain", latitude: 41.385064, longitude: 2.173403) ]
    ...
    fileprivate func save(cities: [City]) {
