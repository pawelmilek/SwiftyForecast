...
class HourlyForecastView: UIView, CustomViewLayoutSetupable, ViewSetupable {
    private var hourlyScrollView = UIScrollView()
    private var hourCells = [HourForecastView]()
